...
public class Tmg_NetworkEfficiency {
	//原有节点数
	int nodenumber = 120;
	...
	public static void main(String[] args) {
		String outfile="tmg/networkefficiency.txt";
		boolean debug=false;
		try {
			...
			Tmg_NetworkEfficiency calculator = new Tmg_NetworkEfficiency();
	...
	private void printValue() {
		...
		Log.writeln("average_networkefficiency is:"+df.format(average_networkefficiency),loglevel);
	}
