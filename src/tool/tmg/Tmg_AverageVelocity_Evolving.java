...
public class Tmg_AverageVelocity_Evolving {
	...
	public Tmg_AverageVelocity_Evolving() {
		crjcmap=new TreeMap[121][121];
	}
	...
	public void getCjeg_BetweenPairs(int source, int destination) {
		Log.writeln("source is:"+source+" destination is:"+destination, level);
	...
	public static void main(String[] args) {
		...
		Tmg_AverageVelocity_Evolving ave = new Tmg_AverageVelocity_Evolving();
		ave.exec();
	}
}
