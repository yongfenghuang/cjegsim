...
/**
 ** @author yfhuang created at 2014-8-26 generate average delays at different time points
 */

public class Reality_AverageDelay_Evolving {
	...
	public Reality_AverageDelay_Evolving() {
	...
	public static void main(String[] args) {
		...
		Reality_AverageDelay_Evolving ave = new Reality_AverageDelay_Evolving();
		ave.exec();
	}
}
