...
/**
 ** @author yfhuang created at 2014-8-26 generate velocities at different time points
 */

public class Reality_AverageVelocity_Evolving {
	...
	public Reality_AverageVelocity_Evolving() {
	...
	public void exec() {
		...
		while (time < maxtime) {
				...
				velocity=velocity/(nodesnumber*(nodesnumber-1));
	...
	public static void main(String[] args) {
		...
		Reality_AverageVelocity_Evolving ave = new Reality_AverageVelocity_Evolving();
		ave.exec();
	}
}
