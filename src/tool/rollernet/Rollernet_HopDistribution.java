...
/**
 ** @author yfhuang created at 2014-8-25 
 */

public class Rollernet_HopDistribution {

	String database = "rollernet";
	static int level = 1000;
	Connection conn;

	public Rollernet_HopDistribution() {
	...
	public static void main(String[] args) {
		...
		Rollernet_HopDistribution hopdis = new Rollernet_HopDistribution();
		hopdis.exec();
	}
}
