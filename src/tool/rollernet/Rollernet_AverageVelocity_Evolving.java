...
public class Rollernet_AverageVelocity_Evolving {
	...
	public Rollernet_AverageVelocity_Evolving() {
	...
	public static void main(String[] args) {
		...
		Rollernet_AverageVelocity_Evolving ave = new Rollernet_AverageVelocity_Evolving();
		ave.exec();
	}
}
