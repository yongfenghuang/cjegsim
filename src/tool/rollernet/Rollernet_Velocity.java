 ...
 *
 */
public class Rollernet_Velocity {
		...
		public static void main(String[] args) {
			...
			try {
				...
				Rollernet_Velocity calculator = new Rollernet_Velocity();
		...
		public void insertToMysql(){
			...
			String sqlstr2 = "INSERT INTO `cjeg_velocity_200` (`source`,`destination`,`velocity`,`nvelocity`) VALUES (?,?,?,?)";  
			try {
